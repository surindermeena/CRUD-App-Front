            ...
            <div className='container-fluid p-5'>
                ...
                <div className='add_button'>
                    <div className="d-flex mb-4">
                         <input className="form-control me-2" type="search" placeholder="Product Barcode" />
                    </div>
                    <NavLink className='btn btn-primary fs-5 me-3'>Product found : {productData.length}</NavLink>
